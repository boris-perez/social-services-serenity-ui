...
import com.dharbor.nexus.application.framework.serenitybdd.QuestionFactory;
import com.dharbor.nexus.application.framework.serenitybdd.TaskFactory;
...
@ContextConfiguration(
        classes = {com.dharbor.nexus.application.Config.class}
)
